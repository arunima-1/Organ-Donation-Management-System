...
public class BankSignup extends Exception{
    ...
    private void signupSignupFunc(){
        ...
        if (user=="" || pass=="" || city=="") {
            ...
            throw new BankSignup("Please complete the form.");
        }
        }
        catch (BankSignup ex) {
        ...
        try{
            ...
            while(rset2.next()){
                System.out.println(rset2.getString("user"));
            }
    ...
    public BankSignup(){
        ...
        bankSignupFrame = new JFrame("Java Project");
        bankSignupFrame.setContentPane(new JLabel(new ImageIcon("C:\\ARTemp\\ODMS-master\\ODMS-master\\dp.png")));
//        super("Sign Up Box");
