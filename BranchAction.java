...
public class BranchAction{
    ...
    private void organActionPerformed(String organName, int val, String branch){
        try{
            ...
            String strSelect6 = "select * from organbank";
            ResultSet rset2 = stmt6.executeQuery(strSelect6);
            while(rset2.next()){
                System.out.println(rset2.getString("Username"));
            }
...
System.out.println(bran);
        ...
        branchActionFrame = new JFrame("Java Project");
        branchActionFrame.setContentPane(new JLabel(new ImageIcon("C:\\ARTemp\\ODMS-master\\ODMS-master\\dp.png")));
//        super("Sign Up Box");
