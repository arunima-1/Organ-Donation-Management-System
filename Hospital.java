...
public class Hospital{
    ...
    static private JButton cityAhmedabad, cityBengaluru, cityChennai, cityHyderabad, cityJaipur;
    ...
    public void cityCaller(String a){
        new Branch(a);
    ...
    public Hospital(){
        ...
        hospitalFrame = new JFrame("Java Project");
        hospitalFrame.setContentPane(new JLabel(new ImageIcon("C:\\ARTemp\\ODMS-master\\ODMS-master\\dp.png")));
...
//        super("Welcome");
        ...
        cityHyderabad = new JButton("Hyderabad");
        ...
        hospitalFrame.add(cityHyderabad);
        ...
        cityHyderabad.setBounds(480, 245, 120, 20);
        cityHyderabad.setFont(f3);
        ...
        cityHyderabad.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                cityCaller("Hyderabad");
            }
        });
